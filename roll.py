...
def menu_descuento():
    des=str(input("si ingresa el codigo de descuento le damos un descuento de 10%"))
    if des==soyotaku:
        print("genial usted ha conseguido un 10 de descuento")
    else:
        print("ERROR usted no es otaku(si se baña)")
